...
class ubication(object):
	...
	def main(self):
		...
		while not rospy.is_shutdown():
			...
			odom.pose.pose.orientation.x = self.enc_LF #Desplazamiento enc izquierdo
			odom.pose.pose.orientation.y = self.enc_RF #Desplazamiento enc derecho
                        odom.pose.pose.orientation.z = self.SL #Desplazamiento enc izquierdo
                        odom.pose.pose.orientation.w = self.SR #Desplazamiento enc derecho
